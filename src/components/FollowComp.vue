<template>
  <v-content>
    <v-card class="mx-auto mr-5 ml-5 mb-8" fill flat outlined v-for="(item, index) in followers" :key="index">
      <v-list-item three-line>
        <v-list-item-avatar tile size="80" class="my-auto">
